...
import { SubmitResponseItem } from "../../types/answers";
import instance from "../../http/instance";
import { getManagerSurvey } from "../../http/requests/companyRequests";
...
const ManagerAssessment = () => {
  ...
  useEffect(() => {
    if (assessment && assessment.questions) {
      ...
      const initialAnswers = assessment.questions.map(question => ({
        managerSurveyQuestionId: question.id,
        selectedOption: ""
      }));
  ...
  const fetchAssessment = async () => {
    ...
    try {
      ...
      const survey = await getManagerSurvey(id);
  ...
  const handleAnswer = (option: string) => {
    ...
    const answerIndex = newAnswers.findIndex(
      a => a.managerSurveyQuestionId === currentQuestionId
    );
  ...
  const currentAnswer = answers.find(
    a => a.managerSurveyQuestionId === currentQuestion.id
  );
